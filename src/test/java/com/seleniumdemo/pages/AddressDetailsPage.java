...
public class AddressDetailsPage {
    ...
    public OrderDetailsPage fillAddress(Customer customer, String comments) {
        ...
        billingAddresInput.sendKeys(String.format("%s %s", customer.getStreet(), customer.getFlatNumber()));
